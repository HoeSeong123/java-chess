...
class ChessBoardGeneratorTest {
    ...
    void ChessBoardGenerator_Create_initial_chess_board() {
        ...
        assertAll(
                ...
                () -> assertThat(result.get(new Position("a", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("b", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("c", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("d", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("e", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("f", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("g", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("h", "6"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("a", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("b", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("c", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("d", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("e", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("f", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("g", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("h", "5"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("a", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("b", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("c", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("d", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("e", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("f", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("g", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("h", "4"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("a", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("b", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("c", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("d", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("e", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("f", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("g", "3"))).isEqualTo(new Empty()),
                () -> assertThat(result.get(new Position("h", "3"))).isEqualTo(new Empty()),
